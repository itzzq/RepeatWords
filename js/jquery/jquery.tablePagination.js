 ...
 */
 ...
 (function($){
	...
	$.fn.tablePagination = function(settings) {
		var defaults = {  
			firstArrow : (new Image()).src="./imgs/first.gif",  
			prevArrow : (new Image()).src="./imgs/prev.gif",
			lastArrow : (new Image()).src="./imgs/last.gif",
			nextArrow : (new Image()).src="./imgs/next.gif",
			rowsPerPage : 10,
			currPage : 1,
			optionsForRows : [1,2,5,7,10],
			ignoreRows : [],
			topNav : false
		};  
